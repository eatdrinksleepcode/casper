...
"%myDir%nuget" install Casper.Console -Version 0.1.0-ci0162 -OutputDirectory "%oldPackageDir%" -pre -Verbosity quiet -Source "MyGet" -ConfigFile "%localNugetConfig%" -ExcludeVersion || goto :eof
